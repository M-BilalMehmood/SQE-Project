...
-- MAKE SURE TO VERIFY ALL THE TABLES => SOMETIMES YOU NEED TO EXECUTE EACH QUERY SEPERATELY => THIS IS WHAT I DID !
...
--
-- Inserting data for table attandance
--
INSERT INTO `attandance` (`subjectcode`, `date`, `rollnumber`, `present`, `courcecode`, `semoryear`) VALUES
('CSE101', '2021-09-01', 2021001, 1, 'CSE', 1),
('CSE101', '2021-09-02', 2021001, 1, 'CSE', 1),
('ECE101', '2021-09-01', 2021002, 1, 'ECE', 1),
('ECE101', '2021-09-02', 2021002, 0, 'ECE', 1);
...
INSERT INTO `chat` (`sr_no`, `fromuserid`, `fromusername`, `touserid`, `message`, `messagetime`, `messagedate`, `readby`) VALUES
(1, 'john.doe', 'John Doe', 'alice.smith', 'Hello Professor!', '10:15:00', '2021-09-01', NULL),
(2, 'alice.smith', 'Dr. Alice Smith', 'john.doe', 'Hello John, how can I help you?', '10:17:00', '2021-09-01', NULL);
...
CREATE TABLE `cources` (
  `sr_no` int(11) NOT NULL,
  `Courcecode` varchar(20) DEFAULT NULL,
  `CourceName` varchar(50) DEFAULT NULL,
  `semoryear` varchar(5) DEFAULT NULL,
  `totalsemoryear` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- need to alter cources table to incorporate longer course names. 
ALTER TABLE `cources` MODIFY `CourceName` varchar(50) DEFAULT NULL;

INSERT INTO `cources` (`Courcecode`, `CourceName`, `semoryear`, `totalsemoryear`) VALUES
('CSE', 'Computer Science and Engineering', 'Sem', 8),
('ECE', 'Electronics and Communication Engineering', 'Sem', 8),
('ME', 'Mechanical Engineering', 'Sem', 8);
...
-- inserting into faculties table:
...
(101, 'Alice Smith', 'California', 'Los Angeles', 'alice.smith@example.com', '+1-555-0100', 'PhD', '10 years', '1975-05-20', 'Female', NULL, 'CSE', 1, 'Introduction to Programming', 'Professor', NULL, NULL, 'pass123', 1, '2010-08-15'),
(102, 'Bob Johnson', 'Texas', 'Austin', 'bob.johnson@example.com', '+1-555-0101', 'Masters', '8 years', '1978-09-12', 'Male', NULL, 'ECE', 1, 'Circuit Theory', 'Associate Professor', NULL, NULL, 'pass123', 1, '2012-09-01'),
(103, 'Carol Martinez', 'New York', 'New York City', 'carol.martinez@example.com', '+1-555-0102', 'PhD', '12 years', '1972-03-08', 'Female', NULL, 'ME', 1, 'Engineering Mechanics', 'Professor', NULL, NULL, 'pass123', 1, '2008-06-20');
...
(`Courcecode`, `semoryear`, `rollnumber`, `optionalsubject`, `firstname`, `lastname`, 
`emailid`, `contactnumber`, `dateofbirth`, `gender`, `state`, `city`, 
`fathername`, `fatheroccupation`, `mothername`, `motheroccupation`, 
`sr_no`, `lastlogin`, `userid`, `password`, `activestatus`, `admissiondate`) 
VALUES
('BCS101', 2, 2023001, 'Data Science', 'John', 'Smith',
'john.smith@email.com', '555-0123', '2003-05-15', 'Male', 'California', 'San Jose',
'Michael Smith', 'Software Engineer', 'Sarah Smith', 'Teacher',
1, '2024-03-15 09:30:00', 'jsmith2023', 'pass123', 1, '2023-08-01'),

('BAC202', 1, 2023045, 'Finance', 'Emily', 'Johnson',
'emily.j@email.com', '555-0124', '2004-08-22', 'Female', 'New York', 'Brooklyn',
'Robert Johnson', 'Accountant', 'Mary Johnson', 'Business Analyst',
2, '2024-03-14 14:20:00', 'ejohnson23', 'pass456', 1, '2023-08-02'),

('BEE303', 3, 2022078, 'Power Systems', 'David', 'Chen',
'david.chen@email.com', '555-0125', '2002-11-30', 'Male', 'Texas', 'Austin',
'James Chen', 'Electrical Engineer', 'Linda Chen', 'Doctor',
3, '2024-03-13 16:45:00', 'dchen22', 'pass789', 1, '2022-08-15');

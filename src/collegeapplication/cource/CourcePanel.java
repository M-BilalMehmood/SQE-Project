...
public class CourcePanel extends JPanel implements ActionListener {
	...
	public void updatetableData() {
		...
		// Add null check before setting model
		if (st != null) {
			...
			// Create an empty table model with column headers
			String[] columns = {"Course Code", "Course Name", "Description", "Sem/Year", "Is Active", "Other Info"};
